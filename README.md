...
## How We Built It
TMS is desktop application. We used PyQT5 to create an interactive GUI. PyQT5 allowed us to built a full user experience. For the backend we used python to enhance different functionality.  
